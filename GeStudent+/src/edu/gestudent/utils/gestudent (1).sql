...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 24 fév. 2020 à 23:13
...
(1, 'aa', '2020-02-29', '01:11'),
(2, 'bb', '2020-02-27', '22:22');
...
--
-- Déchargement des données de la table `tsa`
--

INSERT INTO `tsa` (`idtea`, `idstu`, `idbeh`) VALUES
(1, 11, 7),
(1, 29, 7),
(1, 29, 10),
(1, 31, 7),
...
(1, 'teacher', NULL, 'farah', 'chikhaoui', NULL, 'farah.chikhaoui@esprit.tn', NULL, 0, NULL, 'cuajHuOtewq1w/3Hd3SHjA==', NULL, NULL, NULL, 'teacher', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(30, 'admin', NULL, 'Ayadi', 'Yassine', 'f_5e53f83faf23b.png', NULL, NULL, 0, NULL, 'cuajHuOtewq1w/3Hd3SHjA==', NULL, NULL, NULL, 'admin', '1998-08-27', 29025104, NULL, NULL, NULL, NULL, NULL, NULL),
