...
import edu.gestudent.services.UploadEventServices;
...
public class EventStudent extends Form {
    ...
    Evenement e;
    UploadEventServices uploadservices = new UploadEventServices();
    ...
    public EventStudent(Form previous, Resources theme) {
        ...
        for (Evenement e : ServiceEvenement.getInstance().getAllEvenements()) {
            ...
            String url = "http://localhost/GeStudent/web/img/uploads/" + e.getPhoto();
            ConnectionRequest connection = new ConnectionRequest();
            connection.setUrl(url);
            URLImage imgurl = URLImage.createToStorage(placeHolder, url, url);

            ImageViewer img = new ImageViewer(imgurl.scaled(imgurl.getWidth() , imgurl.getHeight() ));
            Container.add(img);
        ...
        testImage.addActionListener(e -> {
            Display.getInstance().openGallery(new ActionListener() {
                ...
                public void actionPerformed(final ActionEvent evt) {
                    ...
                    FilenameInserver = uploadservices.uploadEvent(path);
